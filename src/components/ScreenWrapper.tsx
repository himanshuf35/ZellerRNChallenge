...
import React, {useContext, useMemo, useState, useCallback, ComponentType, FunctionComponent, FC} from 'react';
...
function ScreenWrapper(
  ...
  const WrappedComponent = (props: MainStackScreenProps) => {
    const {topSafeArea = false, bottomSafeArea = true, initialLoader = false} = options;
